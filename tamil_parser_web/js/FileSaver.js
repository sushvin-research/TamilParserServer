...
|| (function (textContent, fileName, charset, ctype) {
    ...
    if (saveAs && Blob) {
	    if(ctype=="txt") {
		    ...
		    var blob = new Blob([textContent], { type: "application/msword;charset=" + charset });
	    }
	    else if(ctype=="pdf") {
		    var blob = new Blob([textContent], { type: "application/pdf;charset=" + charset });
	    }
	    else if(ctype=="csv") {
		    var blob = new Blob([textContent], { type: "text/csv;charset=" + charset });
	    }
	    else if(ctype=="rtf") {
		    var blob = new Blob([textContent], { type: "text/rtf;charset=" + charset });
	    }
	    else{
		    var blob = new Blob([textContent], { type: "text/plain;charset=" + charset });
	    }
