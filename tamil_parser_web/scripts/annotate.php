...
$postag_command1 = "python3 /Users/sushvinmarimuthu/PycharmProjects/TamilParserServer/tamil_parser_web/scripts/postagger/Method1_WordPOS/method1.py in.txt > pos_method1.txt";
// $postag_command2 = "python3 postagger/Method2_SubWordPOS/method2.py in.txt > pos_method2.txt";
$postag_command2 = "python3 /Users/sushvinmarimuthu/PycharmProjects/TamilParserServer/tamil_parser_web/scripts/postagger/Method2_SubWordPOS/method2.py in.txt > pos_method2.txt";

$convertor_utf2wx_command = "perl /Users/sushvinmarimuthu/PycharmProjects/Tamil-Parser/tools/convertor-indic-1.4.7/convertor_indic.pl  -f=text -s=utf -t=wx -l=tam -i=in_utf.txt > in_wx.txt";
#$convertor_wx2utf_command = "perl /Users/sushvinmarimuthu/PycharmProjects/Tamil-Parser/tools/convertor-indic-1.4.7/convertor_indic.pl -f=text -s=wx -t=utf -l=tam -i=in_temp.txt > in_temp_utf.txt";
$postag_command3 = "sh /Users/sushvinmarimuthu/PycharmProjects/TamilParserServer/tamil_parser_web/scripts/postagger/postagger.sh /Users/sushvinmarimuthu/PycharmProjects/TamilParserServer/tamil_parser_web/ in_utf2.txt";
$convertor_wx2utf_command = "perl /Users/sushvinmarimuthu/PycharmProjects/Tamil-Parser/tools/convertor-indic-1.4.7/convertor_indic.pl  -f=text -s=wx -t=utf -l=tam -i=in_wx_mo.txt > in_utf_mo.txt";

$morph_command = "lt-proc -c  /Users/sushvinmarimuthu/PycharmProjects/TamilParserServer/tamil_parser_web/scripts/mobin/tam_apertium_v2.1.moobj < in_wx.txt > in_wx_mo.txt";
...
if($ret_var33 == 0) {
	$fp_out = fopen("/Users/sushvinmarimuthu/PycharmProjects/TamilParserServer/tamil_parser_web/scripts/postagger/posout.txt","r");
	if ($fp_out) {
		while (($line = fgets($fp_out)) !== false) {
			// process the line read.
			//echo "$line";
...
// 			$morph_data[] = array('token'=>$morph_arr[0], 'feature'=>array_slice($morph_arr,1));
			$morph_data[] = array('feature'=>$morph_arr);
		}
		fclose($fp_out);
	} else {
...
$data = array('status'=>'success','text'=>$text,'message'=>'Morph output fetched.','pos_annotations'=>$pos, 'morph'=>$morph_data);
