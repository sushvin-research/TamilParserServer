...
import os
os.environ['TRANSFORMERS_CACHE'] = 'tamil_parser_web/.poscache/'
...
PATH = "tamil_parser_web/scripts/postagger/Method2_SubWordPOS/Tamil_POS_BertTokenizer_Method2_savedModel.pth"
